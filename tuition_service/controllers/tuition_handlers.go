...
func putAvailableTimeTutor(c *gin.Context) {
...
func deleteAvailableTimeTutor(c *gin.Context) {
	var slot_query models.TimeSlot
...
func getAvailableTimeTutor(c *gin.Context) {
...
func bookTimeTutor(c *gin.Context) {
...
func unbookTimeTutor(c *gin.Context) {
	var slot_query models.BookSlot
...
func getAllBookedTime(c *gin.Context) {
	var slot_query models.TimePaginated_query
...
func InitTuitionRouter(mainRouter *gin.RouterGroup) {
	// require token
	tuitionRouter := mainRouter.Group("/")
	tuitionRouter.Use(middleware.Authentication)

	// for general usage
	tuitionRouter.GET("/courses", getAllCourses)

	// for tutor usage
	tuitionRouter.POST("/putavailabletime", putAvailableTimeTutor)
	tuitionRouter.POST("/deleteavailabletime", deleteAvailableTimeTutor)

	// for student usage
	tuitionRouter.GET("/tutors/*course", getAllTutors)
	tuitionRouter.GET("/availabletime/:tutor", getAvailableTimeTutor)
	tuitionRouter.POST("/book", bookTimeTutor)
	tuitionRouter.POST("/unbook", unbookTimeTutor)
	tuitionRouter.GET("/bookedtime/:user", getAllBookedTime)
}
