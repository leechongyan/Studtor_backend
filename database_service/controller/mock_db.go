...
// type UserCollection map[string]databaseModel.User

// func InitMock() (db mockdb) {
// 	db = mockdb{}
// 	db.UserCollection = make(map[string]databaseModel.User)
// 	return db
// }

// func (db mockdb) GetUsers() (users []databaseModel.User, err error) {
// 	return
// }

// // GetUserById retrieves a user model object by the user's id from the database.
// func (db mockdb) GetUserByID(userID int) (user databaseModel.User, err error) {
// 	return
// }

// // GetUserByEmail retrieves a user model object by the user's email from the database.
// func (db mockdb) GetUserByEmail(email string) (user databaseModel.User, err error) {
// 	user, ok := db.UserCollection[email]
// 	if !ok {
// 		return databaseModel.User{}, databaseError.ErrNoRecordFound
// 	}
// 	return
// }

// // SaveUser saves an auth_model user object into the database.
// func (db mockdb) CreateUser(user databaseModel.User) (err error) {
...
// func (db mockdb) UpdateUser(user databaseModel.User) (err error) {
// 	db.UserCollection[user.Email] = user
// 	return
// }
...
// func (db mockdb) GetCoursesForTutor(tutorID int) (courses []databaseModel.Course, nStudents []int, nTutors []int, err error) {
// 	return
// }

// // GetTutorsForCourse retrieves a list of all tutors for a particular course from the database.
// func (db mockdb) GetTutorsForCourse(courseID int) (tutors []databaseModel.User, err error) {
// 	return
// }
...
// func (db mockdb) GetTutorsForCourseFromIDOfSize(courseID int, tutorID int, size int) (tutors []databaseModel.User, err error) {
// 	return
// }
...
// func (db mockdb) GetTutorsForCourseFromID(courseID int, tut_ID int) (tutors []databaseModel.User, err error) {
// 	return
// }

// // GetTutorsForCourseFromID retrieves a list of tutors for a particular course from the database,
// // starting from 0 to size
// func (db mockdb) GetTutorsForCourseOfSize(courseID int, size int) (tutors []databaseModel.User, err error) {
// 	return
// }
...
// func (db mockdb) GetCourse(courseID int) (course databaseModel.Course, nStudents int, nTutors int, err error) {
// 	return
// }
...
// func (db mockdb) GetCourses() (courses []databaseModel.Course, nStudents []int, nTutors []int, err error) {
// 	return
// }
...
// func (db mockdb) GetSchools() (schools []databaseModel.School, err error) {
// 	return
// }

// // TODO (Jordan GetCoursesIdForSchool gets a list of course code attached the the school)
// func (db mockdb) GetCoursesForSchool(school_id int) (courses databaseModel.SchoolCoursesDetails, err error) {
// 	return
// }

// // GetSchoolByInstitutionAndSchoolCode retrieves a school from the database
// func (db mockdb) GetSchoolByInstitutionAndSchoolCode(institution string, schoolCode string) (school databaseModel.School, err error) {
// 	return
// }
...
// // GetCoursesForSchoolByID(schoolCoursesID string) (schoolCourses []databaseModel.SchoolCoursesDetails, err error)
...
// func (db mockdb) GetBookingsByIDFrom(userID int, fromTime time.Time) (bookings []databaseModel.BookingDetails, err error) {
// 	return
// }

// // GetBookingsByID retrieves a list of all bookings by a user, as indicated by userID, ending with time toTime
// func (db mockdb) GetBookingsByIDTo(userID int, toTime time.Time) (bookings []databaseModel.BookingDetails, err error) {
// 	return
// }
...
// func (db mockdb) GetBookingsByIDFromTo(userID int, fromTime time.Time, toTime time.Time) (bookings []databaseModel.BookingDetails, err error) {
// 	return
// }
...
// func (db mockdb) GetAvailabilityByID(tutorID int) (availabilities []databaseModel.Availability, err error) {
// 	return
// }

// // GetAvailabilityByID retrieves a list of all available timeslots for a tutor, starting from time fromTime
// func (db mockdb) GetAvailabilityByIDFrom(tutorID int, fromTime time.Time) (availabilities []databaseModel.Availability, err error) {
// 	return
// }

// // GetAvailabilityByID retrieves a list of all available timeslots for a tutor, ending with time toTime
// func (db mockdb) GetAvailabilityByIDTo(tutorID int, toTime time.Time) (availabilities []databaseModel.Availability, err error) {
// 	return
// }
